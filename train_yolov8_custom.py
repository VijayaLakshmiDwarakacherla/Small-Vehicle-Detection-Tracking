...
def main():
    ...
    parser.add_argument("--model", type=str, default="models/best_yolo_custom.pt",
                        help="Pretrained YOLOv8 weights (e.g. models/best_yolo_custom.pt, models/yolov8s.pt, or models/yolov8m.pt)")
