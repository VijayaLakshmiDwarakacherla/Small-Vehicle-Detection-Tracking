...
def main():
    ...
    parser.add_argument("--weights", type=str, default="runs/detect/yolov8_2w_custom/weights/best.pt",
                        help="Path to fine-tuned YOLO model weights (or yolo/yolov8s.pt / yolo/yolov8m.pt)")
